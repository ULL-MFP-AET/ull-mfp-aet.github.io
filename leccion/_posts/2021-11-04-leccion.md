...
### Vistando todas las páginas de los alumnos en 10 minutos

```
➜  github-profile-readme gh org-members ULL-MFP-AET-2122 --jq '.[].login'
AdelaGM
Alex100260076
alu0100108859
alu0100879902
...
```
➜  github-profile-readme gh org-members ULL-MFP-AET-2122 --jq '.[].login' | sed -ne 's#^#https://github.com/#p'
