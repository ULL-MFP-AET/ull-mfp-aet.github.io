...
Esto es, alguien - un programador llamado X entusiasmado por tu lenguaje extiende el lenguaje `egg` con una librería llamada `egg-tutu` que publica en [npm](http://npmjs.com).  
