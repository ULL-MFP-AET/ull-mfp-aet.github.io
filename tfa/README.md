...
Esto es, alguien del mundo mundial, un programador llamado X entusiasmado por tu lenguaje Egg-aluXX extiende el lenguaje `egg` con una librería llamada `egg-aluXX-tutu` que publica en [npm](http://npmjs.com).  
