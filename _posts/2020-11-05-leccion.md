...
categories: Clases
tags: markdown github-pages jekyll jekyll-themes emojis
github_alu: 
google_plus: 
---
...
* Luego abordaremos la tarea [p05-t0-aprender-vscode]({{site.baseurl}}/tema0-introduccion/practicas/p05-t0-aprender-vscode) para la que necesitarán traer un portátil (linux, windows o mac os)
